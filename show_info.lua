				...
				if overlayItem then
					...
					if not hero[hand].item then 
						...
						for c = 1, 6 do
							...
							hero[hand].item[c].blink = drawMgr:CreateRect(0,-manaY+6,27*rate,16*rate,0x7CFC0099) hero[hand].item[c].blink.visible = false hero[hand].item[c].blink.entity = v hero[hand].item[c].blink.entityPosition = Vector(0,0,offset)
							hero[hand].item[c].invis_sword = drawMgr:CreateRect(0,-manaY+6,27*rate,16*rate,0x7CFC0099) hero[hand].item[c].invis_sword.visible = false hero[hand].item[c].invis_sword.entity = v hero[hand].item[c].invis_sword.entityPosition = Vector(0,0,offset)
					...
					for c = 1, 6 do
						...
						if see and Items ~= nil then
							...
							elseif Items.name == "item_blink" then
								itemtab[v.classId] = itemtab[v.classId]  + 20*rate
								hero[hand].item[c].blink.visible = true hero[hand].item[c].blink.x = itemtab[v.classId]-manaX-18*rate hero[hand].item[c].blink.textureId = drawMgr:GetTextureId("NyanUI/items/blink")
							elseif Items.name == "item_invis_sword" then
								itemtab[v.classId] = itemtab[v.classId]  + 20*rate
								hero[hand].item[c].invis_sword.visible = true hero[hand].item[c].invis_sword.x = itemtab[v.classId]-manaX-18*rate hero[hand].item[c].invis_sword.textureId = drawMgr:GetTextureId("NyanUI/items/invis_sword")
							...
							elseif itemtab[v.classId] ~= nil then
								...
								hero[hand].item[c].blink.visible = false
								hero[hand].item[c].invis_sword.visible = false
